...
bot = Client(
  'bot'+token.split(":")[0],
  29303355,
 '3497383a173bc579a19ae3ca2f8c6114',
...
- إذا كنـت تريـد أن يكون حسـابك في أمـان
-  تام فاختر بايروجـرام أمـا إذا كـان رقمك حقيقـي فاختر تيليثون .
- ملاحظـة :
...
async def generator_and_about(app,m):
    if m.text == "مـعـلـومـات عـن الـبـوت":
      ...
      text += f"\n\n👤 مـطـور الـبـوت: @Y_D_ll"
      text += f"\n\n🚸 قناة السورس: @SOURCE_EROR"
